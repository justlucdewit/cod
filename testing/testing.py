...
execute_test("t042", expect="100")
execute_test("t043", expect="5")
execute_test("t044", expect="15432")
execute_test("t045", expect="69420")
execute_test("t046", expect="5")
execute_test("t047", expect="70\n71\n72\n")